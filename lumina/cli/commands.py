...
app = typer.Typer(
    ...
    help=f"{__logo__} Lumina - Personal AI Assistant",
...
def onboard(
    ...
    """Initialize Lumina configuration and workspace."""
...
def _run_gateway(
    ...
    *,
    ...
    console.print(f"{__logo__} Starting Lumina gateway version {__version__} on port {port}...")
